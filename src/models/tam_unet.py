...
class TAM_UNet(nn.Module):
    def __init__(self, num_classes=3):
        ...
        self.bottleneck = MultiScaleBottleneck(512, 1024)
        ...
        self.aux_tumor = nn.Conv2d(256, 1, 1)
